...
add('browser_screenshot', 'Capture the target tab via CDP Page.captureScreenshot, NOT captureVisibleTab. Returns an MCP image. Never bring the tab to the front. Full-page captures are bounded to 16 megapixels/16384 CSS pixels.', {tabId:id,fullPage:bool('Capture full document, bounded; default false.'),format:{type:'string',enum:['png','jpeg']}}, ['tabId'], true);
